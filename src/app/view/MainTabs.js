 ...
 * Date: Fri Apr 12 2013 15:10:15 GMT+0800 (CST)
 *
		...
		items: [
			{
				...
				items: [
					...
					},
					{
						...
						disabled: false,
						itemId: 'homeSlider',
						label: 'Stop and notice your body then your emotions. Why are you aware of right now? <br/> (left=overwhelmed, right=balance)',
						labelAlign: 'top',
						value: [
							50
						]
