 ...
 * Date: Sat Apr 20 2013 19:26:33 GMT+0800 (CST)
 *
...
Ext.define('HEART.controller.MainController', {
	...
	onHomeIntentionTap: function(button, e, eOpts) {
	...
	onSettingDone: function(button, e, eOpts) {
		...
		HEART.toUser( {uuid: AJAX.uuid, wake: values.wake_time, sleep: values.sleep_time}, succ, fail );
	...
	onActive: function(container, value, oldValue, eOpts) {
